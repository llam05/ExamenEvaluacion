 ...
 */
public class PrestecAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<Prestec> items;

    public PrestecAdapter(Context context, ArrayList<Prestec> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Prestec item = this.items.get(position);
        nom.setText(item.getCantidad());
        des.setText(item.getPersona());
