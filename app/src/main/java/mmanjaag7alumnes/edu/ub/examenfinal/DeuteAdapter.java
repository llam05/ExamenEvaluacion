 ...
 */
public class DeuteAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<Deute> items;

    public DeuteAdapter(Context context, ArrayList<Deute> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Deute item = this.items.get(position);
